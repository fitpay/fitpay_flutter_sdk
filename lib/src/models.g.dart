...
Funding _$FundingFromJson(Map<String, dynamic> json) {
  return Funding(
    ...
    nextFundingTs: json['nextFundingTs'] == null
        ? null
        : DateTime.parse(json['nextFundingTs'] as String),
