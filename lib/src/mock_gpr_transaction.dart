...
List<GPRTransaction> getGPRTransactions() {
  ...
  Map<String, dynamic> mockTransactionMap = {
    ...
    "merchantName": "Consequat Ultrices",
    "merchantCode": "8661",
  ...
  for (int i = 0; i < copies; i++) {
    mockTransactionMap['amount'] = double.parse((rng.nextDouble()*100).toStringAsPrecision(4));
...
Page<GPRTransaction> mockTransactions = Page<GPRTransaction>(
  ...
  links: {
    ...
    'next': Link(href: "http://localhost:56912/users/69fe7726-d4e8-4857-a7c2-4d7032e4e3bf/creditCards/da5f93f6-b2cb-4243-b459-26ed2a9f4dc7/transactions?limit=2&offset=2")
  },
